...
const RevenueExpenseChart: React.FC = () => {
        ...
        candidatesData?.forEach((candidate, index) => {
          ...
          const parseSalary = (salary: string | number | undefined | null): number => {
            ...
            if (typeof salary === "string") {
              ...
              console.log(`Parsed salary string: ${salary}, Amount: ${amount}, Currency: ${currency}, Budget Type: ${budgetType}`);
            } else {
              amount = salary;
          ...
          const calculateEmployeeHours = (employeeId: string, projectId: string) => {
            ...
            logs.forEach(log => {
              ...
              if (adjustedMonthIndex >= 12 && adjustedMonthIndex < 17) {
                ...
                console.log(`Salary type: ${salaryType}, Hourly salary: ${hourlySalary}, Hours: ${hours}, Expense contribution: ${hours * hourlySalary}`);
          ...
          relevantTimeLogs
            ...
            .forEach(log => {
              ...
              if (adjustedMonthIndex >= 12 && adjustedMonthIndex < 17) {
                ...
                console.log(`Month: ${months[displayMonthIndex]}, Hours in month: ${hoursInMonth}, Proportion: ${proportion}, Revenue contribution: ${revenue * proportion}`);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {/* Revenue Card */}
      <Card className="shadow-xl border-none bg-gradient-to-r from-indigo-600 to-purple-700 text-white overflow-hidden transition-all duration-300 hover:shadow-2xl">
        <CardHeader className="p-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* <span className="bg-white text-indigo-600 rounded-full h-6 w-6 flex items-center justify-center font-semibold">
                25+
              </span> */}
            </div>
          </div>
      ...
      {/* Expense Card */}
      <Card className="shadow-xl border-none bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 overflow-hidden transition-all duration-300 hover:shadow-2xl">
        <CardHeader className="p-6">
          <div className="flex justify-between items-center">
            <CardTitle className="text-xl md:text-2xl font-semibold">
              Expenses
        ...
        <CardContent className="p-6">
          {isLoading ? (
            ...
            <div className="h-[150px]">
              ...
              {/* <div className="flex justify-center mt-4">
                <span className="bg-yellow-600 text-white rounded-full px-3 py-1 text-sm font-semibold">
                  45%
                </span>
              </div> */}
            </div>
