...
import { Download, Plus, Briefcase, DollarSign, TrendingUp } from "lucide-react";
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="p-6 rounded-xl glass-card flex items-center justify-between bg-white shadow-sm border border-gray-200">
              <div>
    ...
    <div className="bg-green-100 p-3 rounded-full">
      <TrendingUp size={24} className="text-green-800" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="glass-card p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={clientFinancials}>
                  ...
                  {/* Projects Bar with new color */}
                  <Bar dataKey="total_projects" fill="#ad94f5" name="Projects" radius={[10, 10, 0, 0]} />
 
                  {/* Revenue Bar with new color */}
                  <Bar dataKey="revenue" fill="#ad94f5" name="Revenue" radius={[10, 10, 0, 0]} />
 
                  {/* Profit Bar with new color */}
                  <Bar dataKey="profit" fill="#ad94f5" name="Profit" radius={[10, 10, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            ...
            <div className="glass-card p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col items-center">
